const pages = [
...

    {
        ...
        content: {
            ...
            description: 'This ioard created using build-in elements and components.',
    ...
    
    {
        output: './robot.html',
        content: {
            title: 'Description du robot',
            description: 'Cette page permet la configuration du robot',
            heading_icon: 'pe-7s-car icon-gradient bg-mean-fruit'
        },
        template: './src/DemoPages/dashboards/dashboard-example-1.hbs'
    },
